...
public final class DialogWifiPasswordBinding implements ViewBinding {
  ...
  private DialogWifiPasswordBinding(@NonNull ConstraintLayout rootView,
      @NonNull TextView errorMessage, @NonNull TextInputEditText passwordInput,
  ...
  public static DialogWifiPasswordBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogWifiPasswordBinding((ConstraintLayout) rootView, errorMessage, passwordInput,
          passwordInputLayout);
    }
